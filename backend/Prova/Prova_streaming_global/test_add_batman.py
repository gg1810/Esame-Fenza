"""
PARTE 1: Aggiunge 100 visioni per "Batman"
Eseguire con: docker exec cinematch_backend python test_add_batman.py
"""
import os
import json
import time
...
def main():
    print("=" * 50)
    print("PARTE 1: AGGIUNTA 100 VISIONI BATMAN")
    print("=" * 50)
    ...
    print("\n🚀 Invio 100 eventi ADD per Batman...")
    for i in range(100):
        event = {
            "event_type": "ADD",
